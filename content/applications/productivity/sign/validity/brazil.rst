...
- **Infraestrutura de Chaves Públicas Brasileira (ICP-Brazil)**: Brazil maintains its own public key
  infrastructure (PKI) for digital certificates called “Infraestrutura de Chaves Públicas
  Brasileira”. These are  digital signature certificates or “seals” that serve as proof of identity
  of an individual for a certain purpose that can be used in special cases to provide additional
  security. These certificates are issued by Certification Authorities and are required by law for
  the signature of specific acts.
...
.. admonition:: Disclaimer
   ...
   constitute legal advice. While Odoo Sign complies with the Electronic Signature Law of Brazil,

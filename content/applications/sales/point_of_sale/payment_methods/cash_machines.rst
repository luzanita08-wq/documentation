...
Configure the cash machine itself before setting it up in Odoo. Currently, Odoo supports the
:doc:`Glory <cash_machines/glory>`, :doc:`Cashdro <cash_machines/cashdro>`, and
:doc:`Cashmatic <cash_machines/cashmatic>` cash machines. Once the cash machine is fully set up:
